...
function connectSockets(http, session) {
  ...
  gIo.on('connection', (socket) => {
    ...
    socket.on('chat newMsg', async (msg) => {
      ...
      gigService.addMsg(socket.myTopic, msg)//save history bonus
    })
    ...
    //for fun delete gig in other browsers
    socket.on('deletegig', (gigId) => {
      //   gIo.to(socket.myTopic).emit('user-typing', user)
      broadcast({ type: 'delete-gig', data: gigId, userId: socket.userId })
    })
